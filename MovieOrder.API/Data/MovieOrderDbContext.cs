...
using MovieOrder.API.Entities;

namespace MovieOrder.API.Data
{
	public class MovieOrderDbContext:DbContext
	{
		public MovieOrderDbContext(DbContextOptions<MovieOrderDbContext> options):base(options)
		{
		}
